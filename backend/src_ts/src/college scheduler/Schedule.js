...
function GetUserObject(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        const [[user_Object], rooms_data, room_ban_times, groups_data, group_ban_times, professors_data, professor_ban_times, courses_data, period_data, period_group, period_ban_times] = yield (0, db_1.async_get_query)(`CALL entire_university_information(${(req.user).university_id})`, connections_1.college_scheduler_connection);
...
function PostSchedule(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield (0, db_1.async_get_query)(`CALL delete_university_schedule(${req.user.university_id})`, connections_1.college_scheduler_connection);
            yield (0, db_1.async_get_query)("INSERT INTO period_coloring VALUES " + sql_string_r.substring(0, sql_string_r.length - 1), connections_1.college_scheduler_connection);
        }
        catch (err) {
            console.log(err);
            return res.send(err);
...
function GetSchedule(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const [prof_data, prof_views, group_data, group_views,] = yield (0, db_1.async_get_query)(`CALL view_schedule(${req.params.userId})`, connections_1.college_scheduler_connection);
            ...
            const { numberOfDays, periodsPerDay } = (yield (0, db_1.async_get_query)(`SELECT days_per_week AS numberOfDays, periods_per_day AS periodsPerDay FROM university WHERE university_id = ${req.params.userId}`, connections_1.college_scheduler_connection))[0];
