...
function DeleteCourse(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield (0, db_1.async_get_query)("DELETE FROM course WHERE course_id = " + req.params.courseId, connections_1.college_scheduler_connection);
...
function CourseAssetsNameList(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const prof_namse = yield (0, db_1.async_get_query)(`
        ...
        `, connections_1.college_scheduler_connection);
            const group_names = yield (0, db_1.async_get_query)(`
